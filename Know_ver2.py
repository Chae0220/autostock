...
access = "noLFnZP742fbrqwbl8v1KEvk4hOvSJ8xg4Uo4dkr"
secret = "PBi9ajhL7eCIFdJzjkHHexs36hXtBUFI1lqpeMtu"
myToken = "xoxb-2117139664064-2078569588871-PTA4WtVORo2u97Tb9yl7ZqMr"
        ...
        while True:
            try:
                if not self.q.empty():
                    ...
                    target_price = (sum(self.close1) / len(self.close1)) + ((sum(self.high1) / len(self.high1)) - (sum(self.low1) / len(self.low1))) * 0.2
                ...
                if buy_flag == False and sell_flag == False and wait_flag == False and \
                   ...
                   curr_ma5 >= curr_ma10 and curr_ma10 >= curr_ma15 and curr_ma15 >= curr_ma20 and price_curr >= target_price:
                    print("[", datetime.datetime.now(), "]", "[BUY_POSSIBLE!]", "    커런트 프라이스 :", price_curr,
                    ...
                    while True:
                        ...
                        if volume == None or 'error' in volume or avg_price == None or 'error' in avg_price:
                            print("매수 주문 이상")
                            continue
